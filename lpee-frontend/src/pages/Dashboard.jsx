...
const menuGroups = [
  { label: "Référentiel", icon: BookOpen, items: [["Unité", "unites"], ["Produit", "produits"], ["Équipement", "equipements"], ["Norme", "normes"], ["Essai", "essais"]] },
...
function Dashboard({ onLogout }) {
  ...
  return <div className="dashboard-shell">
    ...
    <main className="dashboard-content">
      {activePath === "unites" ? <Unite /> : activePath === "produits" ? <Produit /> : activePath === "equipements" ? <Equipement /> : activePath === "normes" ? <Norme /> : activePath === "essais" ? <Essai /> : activePath === "utilisateurs" ? <Utilisateur /> : activePath === "historique" ? <Historique /> : activePath === "profil" ? <Profil /> : activePath === "vue-360" ? <Vue360 /> : <>
